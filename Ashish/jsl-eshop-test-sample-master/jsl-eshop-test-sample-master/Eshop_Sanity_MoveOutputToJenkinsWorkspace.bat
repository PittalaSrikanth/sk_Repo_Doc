REM # ##################################################################################
REM # Name:  Eshop_Sanity_MoveOutputToJenkinsWorkspace.bat
REM # Date: 02/26/2018
REM # Version: 1.1
REM # Author: Arun K.
REM #
...
cls
echo ON
echo %date%:%time%: " Executing Eshop_Sanity_MoveOutputToJenkinsWorkspace...."
...
set ReportsPath=%BaseCodePath%\%AppName%_Framework\EshopTests\reports
set SitePath=%BaseCodePath%\%AppName%_Framework\EShopTests\target\site
set FailsafeReports=%BaseCodePath%\%AppName%_Framework\EShopTests\target\failsafe-reports
set ScreenShotsPath=%BaseCodePath%\%AppName%_Framework\EShopTests\ScreenShots
